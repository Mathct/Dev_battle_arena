...
start "Backend Server" cmd /k "cd /d C:\laragon\www\Projets\DevBattleArena\Dev_battle_arena\backend && node index.js"
...
start "Frontend" cmd /k "cd /d C:\laragon\www\Projets\DevBattleArena\Dev_battle_arena\frontend && npm run dev"
